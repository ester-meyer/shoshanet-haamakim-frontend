    ...
    <section className="contact-section">
      <div className="form-container">
        ...
        <div className="contact-info centered">
          <h2>להזמנות</h2>
          <p>
            <i className="fas fa-map-marker-alt"></i>רשב"י 15 מודיעין עילית
          </p>
          <p>
            <i className="fas fa-phone"></i>08-9744553
          </p>
          <p>
            <i className="fas fa-mobile-alt"></i>053-319-1206
          </p>
          <p>
            <i className="fas fa-envelope"></i>9744553@gmail.com
          </p>
          <div className="maps-links">
            <a href={googleMapsUrl} target="_blank" rel="noopener noreferrer">
              <img src="/google-maps-icon.png" alt="Google Maps" style={{ borderRadius: '8px' }}/>
            </a>
            <a href={wazeUrl} target="_blank" rel="noopener noreferrer">
              <img src="/waze-icon.png" alt="Waze" style={{ borderRadius: '8px' }} />
            </a>
          </div>
        </div>
      </div>
